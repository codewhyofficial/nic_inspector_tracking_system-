            ...
            <form method="POST" action="{{ route('addInspection', ['uiid' => $user->uiid]) }}" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" id="date_of_joining" name="date_of_joining" required value="{{ old('date_of_joining') }}" class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
