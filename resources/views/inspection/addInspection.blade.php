...
<head>
    ...
    <title>Add Inspection Details</title>
...
<body class="">
    ...
    <div class="bg-gray-100 flex flex-col items-center justify-center min-h-screen">
        ...
        <h1 class="text-2xl my-3 font-bold">Add Inspection Details</h1>
        ...
        <div class="bg-white p-8 rounded-lg shadow-md mx-6 relative">
            ...
            <form method="POST" action="{{ route('addInspection', ['uiid' => $user->uiid]) }}" enctype="multipart/form-data" autocomplete="off">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input value="{{$user->name}}" type="text" name="inspector_name" id="inspector_name" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div>
                        ...
                        <select id="inspection_category" name="inspection_category" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            ...
                            <option value="{{ $value }}" {{ old('inspection_category') == $value ? 'selected' : '' }}>{{ $value }}</option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        <input type="date" id="date_of_joining" name="date_of_joining" required value="{{ old('date_of_joining') }}" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="remarks" name="remarks" rows="4" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">{{ old('remarks') }}</textarea>
