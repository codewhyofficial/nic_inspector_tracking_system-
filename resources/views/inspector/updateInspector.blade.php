...
<body class="bg-gray-100 flex flex-col items-center justify-center min-h-screen">
    <h1 class="sm:text-xl md:text-2xl my-6 md:my-10 font-bold">Update Details</h1>
    ...
    <div class="bg-white p-8 rounded-lg shadow-md mx-6 relative">
        ...
        <form action="/submit" method="post" enctype="multipart/form-data" class="sm:grid sm:grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="mb-4">
                ...
                <span class="text-red-700 font-semibold underline hover:cursor-pointer">View Uploaded Document</span>
            </div>
