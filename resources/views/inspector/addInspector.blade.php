            ...
            <form method="POST" action="{{ route('addInspector') }}" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="userid" name="userid" tabindex="1" placeholder="User ID" required value="{{ old('userid') }}" class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" tabindex="2" required value="{{ old('name') }}" class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div>
                        ...
                        <select id="gender" name="gender" tabindex="3" required class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div>
                        ...
                        <input type="date" id="dob" name="dob" tabindex="4" required value="{{ old('dob') }}" class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div>
                        ...
                        <select id="nationality" name="nationality" tabindex="5" required class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <option value="">Select</option>
                    ...
                    <div>
                        ...
                        <select id="placeofbirth" name="placeofbirth" tabindex="6" required class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <option value="">Select</option>
                    ...
                    <div>
                        ...
                        <input type="text" id="passport" name="passport" tabindex="7" placeholder="e.g., A1234567" maxlength="9" required value="{{ old('passport') }}" class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div>
                        ...
                        <input type="text" id="unlp" name="unlp" tabindex="8" placeholder="e.g., AB1234567" maxlength="9" required value="{{ old('unlp') }}" class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div>
                        ...
                        <select id="rank" name="rank" tabindex="9" required class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <option value="">Select</option>
                    ...
                    <div>
                        ...
                        <input type="text" id="qualification" name="qualification" tabindex="10" required value="{{ old('qualification') }}" class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div>
                        ...
                        <input type="text" id="experience" name="experience" tabindex="11" required value="{{ old('experience') }}" class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div>
                        ...
                        <input type="file" id="clearance" name="clearance" tabindex="12" class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="remarks" name="remarks" rows="4" tabindex="14" value="{{ old('remarks') }}" class="mt-1 font-semibold block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"></textarea>
